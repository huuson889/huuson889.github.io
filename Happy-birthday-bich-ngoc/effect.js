...
function loopOne() {
	...
	$('#cake_fadein').click(function(){
		$('.cake').hide().delay(3000).fadeIn('slow');
		$(this).fadeOut('slow').delay(5000).promise().done(function(){
	...
	$('#wish_message').click(function(){
		...
		$('#b11').animate({top:220, left: vw-3.9*bw},500);
		$('#b22').animate({top:220, left: vw-2.9*bw},500);
		$('#b33').animate({top:220, left: vw-1.9*bw},500);
		$('#b44').animate({top:220, left: vw-0.9*bw},500);
		$('#b55').animate({top:220, left: vw},500);
		$('#b66').animate({top:220, left: vw+0.9*bw},500);
		$('#b77').animate({top:220, left: vw+1.9*bw},500);
		$('#b88').animate({top:220, left: vw+2.9*bw},500);
